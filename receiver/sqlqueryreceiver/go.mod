module github.com/Grandys/opentelemetry-collector-contrib/receiver/sqlqueryreceiver
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/sqlquery v0.108.0
